...
class Usuario(db.Model):
    ...
    telefone = db.Column(db.String(50), nullable=True, doc = "Telefone do usuário (máximo 50 caracteres, pode ser NULL).")
    endereco = db.Column(db.String(255), nullable=True, doc = "Endereço do usuário (máximo 255 caracteres, pode ser NULL).")
    ...
    aulas = db.relationship('Aula', backref='professor', lazy=True, doc = "Relacionamento com a entidade Aula. Cada usuário do tipo prodessor pode ministrar várias aulas.")
    cargos = db.relationship('Cargo', backref='usuario', lazy=True, doc = "Relacionamento com a entidade Cargo. Cada usuário pode ter vários cargos associados.")
