...
class Aula (db.Model):
    ...
    Atributos:
        ...
        dias_da_semana (str): Os dias da semana que a aula ocorre (máximo de 100 caracteres).
        usuario_cpf (str): O cpf do professor que ministra a aula (máximo de 20 caracteres).
