        ...
        <Row className="gap-5">
          <Col>
            <Form.Group className="d-flex flex-column gap-1">
              ...
              <Alert
                variant="white"
                className={`${errors.numero ? "" : "d-none"} text-danger`}
              >
                {errors.numero?.type === "equal" &&
                  "Uma sala já existe com esse número"}
          ...
          <Col>
            <Form.Group className="d-flex flex-column gap-1">
              ...
              <Alert
                variant="white"
                className={`${errors.capacidade ? "" : "d-none"} text-danger`}
              >
                {errors.capacidade?.type === "required" &&
                  "A capacidade é obrigatória"}
                {errors.capacidade?.type === "min" &&
                  "A capacidade deve ser maior que 10"}
                {errors.capacidade?.type === "max" &&
                  "A capacidade deve ser menor que 500"}
              </Alert>
            </Form.Group>
          </Col>
        </Row>
        <Form.Group className="d-flex flex-column gap-1">
          <Form.Label htmlFor="localizacao">
          ...
          <Alert
            variant="white"
            className={`${errors.localizacao ? "" : "d-none"} text-danger`}
          >
            {errors.localizacao?.type === "required" &&
              "A localização é obrigatória"}
            {errors.localizacao?.type === "minLength" &&
              "A localização deve ter no mínimo 2 caracteres"}
            {errors.localizacao?.type === "maxLength" &&
