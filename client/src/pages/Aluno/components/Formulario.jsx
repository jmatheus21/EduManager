...
const Formulario = ({ enviarFormulario, alteracao }) => {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      if (error.message === "Turma não existe") {
        setError("turma_id", { type: "void" });
      }
      
      if (
        error.message ===
        "A turma está fechada, portanto, não é possível cadastrar mais alunos"
      ) {
        setError("turma_id", { type: "invalid" });
      }
            ...
            <Form.Group className="d-flex flex-column gap-1">
              ...
              >
                ...
                {errors?.data_de_nascimento?.type === "validate" &&
                  "O usuário deve ter entre 6 e 100 anos"}
              </Alert>
            </Form.Group>
          </Col>
        </Row>
            ...
            <Form.Group className="d-flex flex-column gap-1">
              ...
              >
                ...
                {errors?.turma_id?.type === "invalid" &&
                  "A turma está consolidada, ou seja, não é possível matricular o aluno"}
              </Alert>
            </Form.Group>
          </Col>
        </Row>
