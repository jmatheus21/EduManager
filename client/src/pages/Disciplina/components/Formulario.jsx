          ...
          <Col>
            ...
            >
              ...
              {errors?.nome?.type == "minLength" &&
                "O nome da disciplina deve ter no mínimo 3 caracteres"}
              {errors?.nome?.type == "maxLength" &&
                "O nome da disciplina deve ter no máximo 50 caracteres"}
            </Alert>
          </Col>
        </Row>
        <Row className="gap-5">
          <Col>
            ...
            <Alert
              variant="white"
              className={`${errors.codigo ? "" : "d-none"} text-danger`}
            >
              {errors?.codigo?.type == "equal" &&
                "O código da disciplina já existe"}
          ...
          <Col>
            <Form.Group className="d-flex flex-column gap-1">
              <Form.Label htmlFor="carga_horaria">
                Carga Horária: <span className="text-danger">*</span>
              </Form.Label>
              <Form.Control
                id="carga_horaria"
                type="number"
            ...
            <Alert
              variant="white"
              className={`${errors.carga_horaria ? "" : "d-none"} text-danger`}
            >
              {errors?.carga_horaria?.type == "required" &&
                "A carga horária é obrigatória"}
              {errors?.carga_horaria?.type == "min" &&
                "A carga horária deve ser de no mínimo 15"}
              {errors?.carga_horaria?.type == "max" &&
                "A carga horária deve ser no máximo 120"}
            </Alert>
          </Col>
        </Row>
        <Row className="gap-5">
          <Col>
            ...
            <Alert
              variant="white"
              className={`${errors.ementa ? "" : "d-none"} text-danger`}
            >
              {errors?.ementa?.type == "maxLength" &&
                "A ementa deve ter no máximo 255 caracteres"}
            </Alert>
          </Col>
        </Row>
        <Row className="gap-5">
          <Col>
            ...
            <Alert
              variant="white"
              className={`${errors.bibliografia ? "" : "d-none"} text-danger`}
            >
              {errors?.bibliografia?.type == "maxLength" &&
                "A bibliografia deve ter no máximo 255 caracteres"}
            </Alert>
          </Col>
        </Row>
        <Row>
